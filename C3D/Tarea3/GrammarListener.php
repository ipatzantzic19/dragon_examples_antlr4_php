...
interface GrammarListener extends ParseTreeListener {
	 ...
	 * labeled alternative in {@see GrammarParser::condition()}.
	 * @param $context The parse tree.
	 */
	public function enterCondOr(Context\CondOrContext $context): void;
	/**
	 * Exit a parse tree produced by the `CondOr` labeled alternative
	...
	/**
	 * Exit a parse tree produced by the `CondAnd` labeled alternative
	 * in {@see GrammarParser::condition()}.
	 * @param $context The parse tree.
	 */
	public function exitCondAnd(Context\CondAndContext $context): void;
	/**
	 * Enter a parse tree produced by the `CondRelOp`
	 * labeled alternative in {@see GrammarParser::condition()}.
	 * @param $context The parse tree.
	 */
	public function enterCondRelOp(Context\CondRelOpContext $context): void;
	/**
	 * Exit a parse tree produced by the `CondRelOp` labeled alternative
	 * in {@see GrammarParser::condition()}.
	 * @param $context The parse tree.
	 */
	public function exitCondRelOp(Context\CondRelOpContext $context): void;
	/**
	 * Enter a parse tree produced by the `CondParen`
	 * labeled alternative in {@see GrammarParser::condition()}.
	 * @param $context The parse tree.
	 */
	public function enterCondParen(Context\CondParenContext $context): void;
	/**
	 * Exit a parse tree produced by the `CondParen` labeled alternative
	 * in {@see GrammarParser::condition()}.
	 * @param $context The parse tree.
	 */
